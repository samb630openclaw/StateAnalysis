#!/usr/bin/env python3
"""
Minnesota Analysis: Memorial Highways vs Demographics
"""
...
# Paths
demographics_path = "/media/sam/USB DISK/openclaw-capstone-agent/Capstone/Capstone-states/states/minnesota_counties_demographics.csv"
highways_path = "/media/sam/USB DISK/openclaw-capstone-agent/Capstone/Capstone-states/states/minnesota/minnesota_memorial_highways.csv"
output_dir = "/media/sam/USB DISK/openclaw-capstone-agent/results/"

print("=== Minnesota Analysis: Memorial Highways vs Demographics ===")
...
if county_cols:
    ...
    # Clean county names
    demographics['county_clean'] = demographics[county_col].str.replace(r', Minnesota', '', regex=True)
...
demographics.to_csv(os.path.join(output_dir, 'minnesota_demographics_cleaned.csv'), index=False)
print(f"Saved cleaned demographics to: {os.path.join(output_dir, 'minnesota_demographics_cleaned.csv')}")
print()

print("=== Analysis Complete ===")
print("Note: Minnesota analysis limited due to lack of county-level highway data.")
